...
public class Item_Details {
    ...
    public Item_Details() {
        ...
        Parent_JFrame.getMainFrame().setTitle("Item Details - Lease-A-Item Management System");
...
//"Sr#", "ID", "Name", "Model", "Type", "Specifications", "Length", "Breadth","Height", "Weight", "Rent/hr"
        String[] columns =  {"Sr#", "ID", "Name", "Model", "Type", "Specifications", "length", "breadth", "height",
            "weight", "Rent/hour"};
    ...
    private class Item_Details_ActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch (e.getActionCommand()) {
                ...
                break;
                case "Back": {
                    Parent_JFrame.getMainFrame().setTitle("Rent-A-Item Management System [REBORN]");
