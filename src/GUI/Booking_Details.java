...
public class Booking_Details {
    ...
    public Booking_Details() {
        ...
        Parent_JFrame.getMainFrame().setTitle("Booking Details - Lease-A-Item Management System");
        ...
        jTable1 = new JTable();
//ID,  Maker,  Name,  Colour,  Type,  SeatingCapacity,  Model,  Condition,  RegNo, RentPerHour,  IsRented RentDate, itemOwner customer

        String[] columns = {"Sr#", "ID", "Customer ID+Name", "Item Name", "Rent Time", "Return Time"};
...
//RentPerHour,  IsRented RentDate, ItemOwner customer
            ...
            String[] one_s_Record = {((i + 1) + ""), "" + ID, customer_ID_Name, itemID+": "+itemName, rentTime, returnTime};
    ...
    private class Booking_Details_ActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch (e.getActionCommand()) {
                ...
                case "Back": {
                    Parent_JFrame.getMainFrame().setTitle("Lease-A-Item Management System [REBORN]");
                        ...
                        if (Customer.isIDvalid(customerID)) {
                            ...
                            if (customer != null) {
                                ...
                                if (!bookings.isEmpty()) {
                                    ...
                                    JOptionPane.showMessageDialog(null, "This Customer has not booked any items yet !");
                                }
                            } else {
